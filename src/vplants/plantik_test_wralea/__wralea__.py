...
# This file has been generated at Fri Oct 29 10:45:30 2010
...
__all__ = ['ConfigParams', 'ConfigParserRead', 'ConfigParserSave', 'ConfigParserGenerator']
...
ConfigParams = CompositeNodeFactory(name='ConfigParams',
   ...
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  8: {'position': [-413.6283700440847, -221.52664580917082], 'userColor': None, 'useUserColor': False},
   9: {'position': [-44.525972425313498, -207.48921794682374], 'userColor': None, 'useUserColor': False},
   10: {'position': [-46.262239563353603, -300.56077030257586], 'userColor': None, 'useUserColor': False},
   11: {'visualStyle': 1, 'position': [-126.43098926096373, -405.45110349205618], 'color': None, 'text': u'The same operation can be done \ndirectly', 'textColor': None, 'rectP2': (-1, -1)},
   12: {'visualStyle': 1, 'position': [-483.53285109874753, -399.26146913463958], 'color': None, 'text': u'Read a ConfigParser and\nconvert it into a ConfigParams\nobject (which contains the original \nConfigParser instance)', 'textColor': None, 'rectP2': (-1, -1)},
   13: {'position': [-373.50409129814858, -275.85890745138317], 'userColor': None, 'useUserColor': False},
   14: {'position': [-381.88031640368263, -169.27533888996243], 'userColor': None, 'useUserColor': False},
